...
function setContactList(array, index) {
    let firstLetter = array[index].firstLetter
    if (!firstLetter) {
        firstLetter = 'A'
    }
    let template;
...
function setAddOverlayContent() {
    ...
    template = `<div class="overlay-logo">
                    <div class="overlay-img-container">
                        <img src="assets/icon-img/join-main-logo.png" alt="">
                    </div>
                    <div id="overlayTitle">
                    ...
                    <div class="add-contact-text">
                        ...
                        <div class="add-contact-text-form">
                            <div>
                                ...
                                <img src="assets/icon-img/person (2).svg" alt="" class="name-icon">
                            </div>
                            <div>
                                <input type="text" id="email" placeholder="email">
                                <img src="assets/icon-img/mail.svg" alt="" class="mail-icon">
                            </div>
                            <div>
                                <input type="text" id="phone" placeholder="phone">
                                <img src="assets/icon-img/call.svg" alt="" class="phoneNumber-icon">
                            </div>
                        </div>
